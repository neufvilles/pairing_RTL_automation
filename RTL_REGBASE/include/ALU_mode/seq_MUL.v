...
0: begin
	...
	add2_opr1 <= reg_list[inst_addr_opr2 + 5]; add2_opr2 <= reg_list[inst_addr_opr2 + 7]; issub2 <= 0;
	...
	add1_opr1 <= reg_list[inst_addr_opr2 + 0]; add1_opr2 <= reg_list[inst_addr_opr2 + 4]; issub1 <= 0;
	add0_opr1 <= reg_list[inst_addr_opr2 + 5]; add0_opr2 <= reg_list[inst_addr_opr2 + 9]; issub0 <= 0;
	add4_opr1 <= reg_list[inst_addr_opr2 + 7]; add4_opr2 <= reg_list[inst_addr_opr2 + 11]; issub4 <= 0;
	state <= state + 1;
end
1: begin
	add4_opr1 <= reg_list[inst_addr_opr1 + 1]; add4_opr2 <= reg_list[inst_addr_opr1 + 3]; issub4 <= 0;
	add5_opr1 <= reg_list[inst_addr_opr2 + 1]; add5_opr2 <= reg_list[inst_addr_opr2 + 3]; issub5 <= 0;
	...
	add7_opr1 <= reg_list[inst_addr_opr2 + 8]; add7_opr2 <= reg_list[inst_addr_opr2 + 10]; issub7 <= 0;
...
2: begin
	...
	add0_opr1 <= reg_list[inst_addr_opr2 + 9]; add0_opr2 <= reg_list[inst_addr_opr2 + 11]; issub0 <= 0;
	...
	add3_opr1 <= reg_list[inst_addr_opr2 + 4]; add3_opr2 <= reg_list[inst_addr_opr2 + 8]; issub3 <= 0;
...
3: begin
	...
	add2_opr1 <= reg_list[inst_addr_opr2 + 0]; add2_opr2 <= reg_list[inst_addr_opr2 + 2]; issub2 <= 0;
	add0_opr1 <= reg_list[inst_addr_opr2 + 4]; add0_opr2 <= reg_list[inst_addr_opr2 + 6]; issub0 <= 0;
	add7_opr1 <= reg_list[inst_addr_opr2 + 1]; add7_opr2 <= reg_list[inst_addr_opr2 + 5]; issub7 <= 0;
	add4_opr1 <= reg_list[inst_addr_opr2 + 2]; add4_opr2 <= reg_list[inst_addr_opr2 + 6]; issub4 <= 0;
	add5_opr1 <= reg_list[inst_addr_opr2 + 3]; add5_opr2 <= reg_list[inst_addr_opr2 + 7]; issub5 <= 0;
...
4: begin
	...
	add3_opr1 <= add7_out; add3_opr2 <= add5_out; issub3 <= 0;
	add1_opr1 <= reg_list[inst_addr_opr2 + 6]; add1_opr2 <= reg_list[inst_addr_opr2 + 10]; issub1 <= 0;
...
5: begin
	...
	add7_opr1 <= mid_reg_list[0]; add7_opr2 <= mid_reg_list[1]; issub7 <= 0;
	add5_opr1 <= mid_reg_list[12]; add5_opr2 <= mid_reg_list[2]; issub5 <= 0;
	...
	add1_opr1 <= mid_reg_list[7]; add1_opr2 <= add4_out; issub1 <= 0;
	add6_opr1 <= add1_out; add6_opr2 <= mid_reg_list[18]; issub6 <= 0;
	add0_opr1 <= mid_reg_list[26]; add0_opr2 <= add1_out; issub0 <= 0;
	add2_opr1 <= mid_reg_list[8]; add2_opr2 <= mid_reg_list[9]; issub2 <= 0;
...
13: begin
	add0_opr1 <= mm0_out2; add0_opr2 <= add0_out; issub0 <= 0;
	add6_opr1 <= const1_out1; add6_opr2 <= add7_out; issub6 <= 0;
	add5_opr1 <= mm0_out1; add5_opr2 <= add2_out; issub5 <= 0;
	add2_opr1 <= mm0_out2; add2_opr2 <= mid_reg_list[11]; issub2 <= 0;
	add7_opr1 <= mm0_out1; add7_opr2 <= mid_reg_list[5]; issub7 <= 0;
	add3_opr1 <= mm0_out2; add3_opr2 <= mid_reg_list[6]; issub3 <= 0;
...
14: begin
	add2_opr1 <= mid_reg_list[28]; add2_opr2 <= add6_out; issub2 <= 0;
	...
	add7_opr1 <= mm0_out1; add7_opr2 <= mid_reg_list[13]; issub7 <= 0;
	add5_opr1 <= mm0_out2; add5_opr2 <= mid_reg_list[14]; issub5 <= 0;
...
15: begin
	...
	add4_opr1 <= add1_out; add4_opr2 <= add5_out; issub4 <= 0;
...
17: begin
	...
	add0_opr1 <= mm0_out2; add0_opr2 <= add5_out; issub0 <= 0;
...
18: begin
	...
	add2_opr1 <= mid_reg_list[9]; add2_opr2 <= add1_out; issub2 <= 0;
	mid_reg_list[22] <= add7_out_reg;
	mid_reg_list[23] <= add1_out_reg;
	state <= state + 1;
end
...
21: begin
	add1_opr1 <= mm0_out2; add1_opr2 <= add6_out; issub1 <= 0;
	add2_opr1 <= const1_out1; add2_opr2 <= add0_out; issub2 <= 0;
	add3_opr1 <= mm0_out1; add3_opr2 <= mid_reg_list[8]; issub3 <= 0;
	add0_opr1 <= mm0_out2; add0_opr2 <= mid_reg_list[10]; issub0 <= 0;
	add6_opr1 <= mid_reg_list[12]; add6_opr2 <= add2_out; issub6 <= 0;
	add5_opr1 <= const0_out2; add5_opr2 <= const1_out1; issub5 <= 0;
	add7_opr1 <= reg_list[`RAM_ZERO]; add7_opr2 <= const1_out2; issub7 <= 1;
	add4_opr1 <= add5_out; add4_opr2 <= mid_reg_list[24]; issub4 <= 0;
...
22: begin
	add4_opr1 <= mm0_out1; add4_opr2 <= add2_out; issub4 <= 0;
	add1_opr1 <= mid_reg_list[4]; add1_opr2 <= add5_out; issub1 <= 0;
	add3_opr1 <= reg_list[`RAM_ZERO]; add3_opr2 <= add5_out; issub3 <= 0;
	add5_opr1 <= const0_out1; add5_opr2 <= add7_out; issub5 <= 0;
	add2_opr1 <= add2_out; add2_opr2 <= mid_reg_list[25]; issub2 <= 0;
...
23: begin
	add3_opr1 <= mid_reg_list[4]; add3_opr2 <= add6_out; issub3 <= 0;
	add4_opr1 <= mid_reg_list[12]; add4_opr2 <= add7_out; issub4 <= 0;
	add2_opr1 <= add0_out; add2_opr2 <= mid_reg_list[11]; issub2 <= 0;
...
24: begin
	...
	add1_opr1 <= add6_out; add1_opr2 <= mid_reg_list[6]; issub1 <= 0;
	add3_opr1 <= reg_list[`RAM_ZERO]; add3_opr2 <= add5_out; issub3 <= 0;
	add4_opr1 <= mm0_out2; add4_opr2 <= add1_out; issub4 <= 0;
...
25: begin
	...
	add0_opr1 <= mid_reg_list[19]; add0_opr2 <= add2_out; issub0 <= 0;
...
27: begin
	...
	add2_opr1 <= add6_out; add2_opr2 <= mid_reg_list[9]; issub2 <= 0;
	add7_opr1 <= add0_out; add7_opr2 <= mid_reg_list[17]; issub7 <= 0;
...
30: begin
	add1_opr1 <= mid_reg_list[0]; add1_opr2 <= add1_out; issub1 <= 0;
	add0_opr1 <= reg_list[`RAM_ZERO]; add0_opr2 <= add0_out; issub0 <= 0;
	state <= state + 1;
end
31: begin
	reg_list[ret_addr + 1] <= add1_out;
	add0_opr1 <= mid_reg_list[5]; add0_opr2 <= add0_out; issub0 <= 0;
	state <= state + 1;
end
32: begin
