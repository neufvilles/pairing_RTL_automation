...
1: begin
	mm0_opr10 <= reg_list[`RAM_QY0]; mm0_opr11 <= reg_list[`RAM_QY1]; mm0_opr20 <= reg_list[`RAM_TZ0]; mm0_opr21 <= reg_list[`RAM_TZ1]; 
	state <= state + 1;
end
2: begin
	state <= state + 1;
...
12: begin
	mm0_opr10 <= reg_list[`RAM_QY0]; mm0_opr11 <= reg_list[`RAM_QY1]; mm0_opr20 <= mid_reg_list[0]; mm0_opr21 <= mid_reg_list[1]; 
