...
set rtl_dir "."
set rtl_src [list ${{rtl_dir}}/top.v ${{rtl_dir}}/CommandBuffer.v ${{rtl_dir}}/CalculationCore.v ${{rtl_dir}}/AddSubMod.v ${{rtl_dir}}/AddSubModDP.v ${{rtl_dir}}/ConstMultMod.v ${{rtl_dir}}/ConstMultModCore6x.v ${{rtl_dir}}/MontMult2.v ${{rtl_dir}}/inversion/MontgomeryInverter.v ${{rtl_dir}}/inversion/Div2.v ${{rtl_dir}}/inversion/Div4.v ${{rtl_dir}}/inversion/Div4PathUnit.v]
